...
void main() {
  group('Service category filtering', () {
    ...
    test('Filter hair', () {
      final List<Service> filtered = services
          .where((s) => s.category == ServiceCategory.hair)
          .toList();
    ...
    test('Filter beard', () {
      final List<Service> filtered = services
          .where((s) => s.category == ServiceCategory.beard)
          .toList();
      expect(filtered.length, 1);
    ...
    test('Filter combo', () {
      final List<Service> filtered = services
          .where((s) => s.category == ServiceCategory.combo)
          .toList();
      expect(filtered.length, 1);
